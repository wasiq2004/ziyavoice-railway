...
// Service for retrieving plaintext API keys for external API calls
var ExternalApiService = /** @class */ (function () {
    function ExternalApiService() {
    }
    // Get a user's plaintext API key for a specific service
    // This should only be used internally for making external API calls
    ExternalApiService.getUserPlaintextApiKey = function (userId, serviceName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error fetching user plaintext API key:', error_1);
